                    ...
                    <form action="<?php echo e(route('productos.update', $producto->id_producto)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" 
                                      rows="4" required><?php echo e(old('descripcion', $producto->descripcion)); ?></textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" step="0.01" min="0" class="form-control" 
                                       id="precio" name="precio" value="<?php echo e(old('precio', $producto->precio)); ?>" required>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label for="stock" class="form-label">Stock</label>
                                <input type="number" min="0" class="form-control" 
                                       id="stock" name="stock" value="<?php echo e(old('stock', $producto->stock)); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select" id="estatus" name="estatus" required>
                                <option value="activo" <?php echo e($producto->estatus == 'activo' ? 'selected' : ''); ?>>Activo</option>
                                <option value="inactivo" <?php echo e($producto->estatus == 'inactivo' ? 'selected' : ''); ?>>Inactivo</option>
                                <option value="agotado" <?php echo e($producto->estatus == 'agotado' ? 'selected' : ''); ?>>Agotado</option>
                            </select>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="<?php echo e(route('galeria')); ?>" class="btn btn-outline-secondary">
...
</html><?php /**PATH C:\xampp\htdocs\laravel\animex\resources\views/productos/edit.blade.php ENDPATH**/ ?>