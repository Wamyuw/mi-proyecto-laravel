   ...
   <nav class="navbar">
    ...
    <div class="container mt-5">
        <div class="content-section">
            ...
            <form action="<?php echo e(route('usuarios.store')); ?>" method="POST" class="custom-form">
                <?php echo csrf_field(); ?>
                <div class="mb-4">
                ...
                <button type="submit" class="btn btn-primary custom-btn">Registrar Usuario</button>
            </form>
        </div>
    </div>
    <!-- Footer -->
...
</html><?php /**PATH C:\xampp\htdocs\laravel\animex\resources\views/usuarios/create.blade.php ENDPATH**/ ?>