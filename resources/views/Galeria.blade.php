            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-item text-center">
                        <img class="product-img" src="{{ asset('storage/'.$producto->imagen) }}" alt="{{$producto->nombre}}">
                        <h4 class="product-title">{{$producto->nombre}}</h4>
                        <p class="product-info">Descripción: {{$producto->descripcion}}</p>
                        <p class="product-info">Precio: ${{ number_format($producto->precio, 2) }}</p>
                        <p class="product-info">Stock: {{$producto->stock}}</p>
                        <p class="product-info">Estado: {{$producto->estado == 1 ? 'Activo' : 'Inactivo'}}</p>
                        
                        <div class="d-flex justify-content-center flex-wrap">
                            <!-- Botón para editar -->
                            <a href="{{ route('productos.edit', $producto->id_producto) }}" class="btn btn-action btn-edit">Editar</a>
                            ...
                            <form action="{{ route('carrito.agregar', $producto->id_producto) }}" method="POST" class="d-inline">
                                @csrf
