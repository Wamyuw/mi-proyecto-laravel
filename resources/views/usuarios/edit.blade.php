   ...
   <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="{{ route('usuarios.galeria') }}" class="active">Usuarios</a>
        ...
        <div class="content-section">
            ...
            <form action="{{ route('productos.update', $producto->id_producto) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="foto_perfil" class="form-control" value="{{ old('foto_perfil', $usuario->foto_perfil) }}">
                    @if($usuario->foto_perfil)
                        <div class="mt-2">
                            <img src="{{ $usuario->foto_perfil }}" alt="Foto actual" style="max-width: 100px; border-radius: 50%; border: 2px solid var(--primary-color);">
                        </div>
                    @endif
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('usuarios.galeria') }}" class="custom-btn btn-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <footer class="custom-footer">
        <p>&copy; {{ date('Y') }} AnimeX. Todos los derechos reservados.</p>
    </footer>
